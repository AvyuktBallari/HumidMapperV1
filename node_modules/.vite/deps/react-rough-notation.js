...
var GroupDispatchContext = (0, import_react.createContext)(null);
var initialState = {
  annotations: []
};
...
var RoughNotationGroup = function(_a) {
  ...
  var _b = (0, import_react.useReducer)(reducer, initialState), state = _b[0], dispatch = _b[1];
  var timeouts = (0, import_react.useRef)([]);
  (0, import_react.useEffect)(function() {
    var nextTimeout = 0;
    state.annotations.forEach(function(_a2) {
      var annotation = _a2.annotation;
      if (show) {
        ...
        annotation.hide();
        timeouts.current.forEach(function(timeout2) {
          clearTimeout(timeout2);
          timeouts.current = timeouts.current.filter(function(currentTimeout) {
            return currentTimeout !== timeout2;
          });
        });
      }
    });
  ...
  return import_react.default.createElement(
    ...
    { value: state },
    import_react.default.createElement(GroupDispatchContext.Provider, { value: dispatch }, children)
  );
};
var useGroupContext = function(annotation, order) {
  var context = (0, import_react.useContext)(GroupContext);
  var dispatch = (0, import_react.useContext)(GroupDispatchContext);
  var initialProps = (0, import_react.useRef)({ annotation, context, dispatch, order });
  (0, import_react.useEffect)(function() {
...
var RoughNotation = function(_a) {
  ...
  var element = (0, import_react.useRef)(null);
  var annotation = (0, import_react.useRef)();
  var innerVars = (0, import_react.useRef)({
    playing: false,
    timeout: null
  });
  var initialOptions = (0, import_react.useRef)({
    animate,
    animationDuration,
    brackets,
    color,
  ...
  var showAnnotation = (0, import_react.useCallback)(function() {
    if (!innerVars.current.timeout) {
      innerVars.current.timeout = window.setTimeout(function() {
        var _a2, _b2;
        innerVars.current.playing = true;
        (_b2 = (_a2 = annotation.current) === null || _a2 === void 0 ? void 0 : _a2.show) === null || _b2 === void 0 ? void 0 : _b2.call(_a2);
  ...
  var hideAnnotation = (0, import_react.useCallback)(function() {
    var _a2, _b2;
    (_b2 = (_a2 = annotation.current) === null || _a2 === void 0 ? void 0 : _a2.hide) === null || _b2 === void 0 ? void 0 : _b2.call(_a2);
    innerVars.current.playing = false;
    if (innerVars.current.timeout) {
  ...
  var getAnnotation = (0, import_react.useCallback)(function() {
  ...
  (0, import_react.useEffect)(function() {
    ...
    return function() {
      var _a2, _b2;
      (_b2 = (_a2 = annotation.current) === null || _a2 === void 0 ? void 0 : _a2.remove) === null || _b2 === void 0 ? void 0 : _b2.call(_a2);
    };
  }, []);
  (0, import_react.useEffect)(function() {
    if (show) {
  ...
  return import_react.default.createElement(customElement, __assign({ ref: element }, rest), children);
};
export {
  RoughNotation,
  RoughNotationGroup
...
react-rough-notation/dist/module.es.js:
  (*! *****************************************************************************
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=react-rough-notation.js.map
